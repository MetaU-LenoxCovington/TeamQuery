...
export class PermissionError extends BaseError {
  constructor(
    message: string,
    code: number = ERROR_CODES.INSUFFICIENT_PERMISSIONS
  ) {
  ...
  static membershipRequired(
    message: string = 'Organization membership required'
  ) {
